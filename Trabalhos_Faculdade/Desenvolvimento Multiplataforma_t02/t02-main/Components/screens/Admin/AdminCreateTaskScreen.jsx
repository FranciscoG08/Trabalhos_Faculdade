...
import { db } from '../../services/FirebaseConfig'; // Importe o db do arquivo firebase.js
import { collection, addDoc, serverTimestamp } from 'firebase/firestore'; // Importe addDoc e serverTimestamp

const AdminCreateTaskScreen = () => {
    ...
    <View style={styles.container}>
      <ImageBackground source={fundo_task} style={styles.imageBackground}>
        ...
        <View style={styles.botoesRow}>
          <TouchableOpacity style={styles.buttonContainerCheckmark} onPress={handleSaveTask}>
...
export default AdminCreateTaskScreen;