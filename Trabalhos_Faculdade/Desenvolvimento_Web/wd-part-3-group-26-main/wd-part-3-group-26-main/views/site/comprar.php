<?php
//Pagina para o comprar
/** @var yii\web\View $this */

use yii\helpers\Html;
use yii\helpers\Url;
$this->registerCssFile(Yii::$app->request->baseUrl . '/css/estilo_compra.css', ['position' => \yii\web\View::POS_HEAD]);
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="estilo_compra.css">
...
<body>
  ...
  <main>
    <div class="container-fluid bg-danger px-0">
      <div class="row g-0 bg-info fundo">
        <div class="col-md-12 d-flex align-items-center justify-content-center">
          <div class="caixa_pesquisa_outside d-flex align-items-center justify-content-center">
            <div class="caixa_pesquisa_inside">
              <div class="row">
                <div class="col-md-12 d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-6">
                  <select class="dropdown_buttons_1 dropdown-button" aria-label="Organizar-Por"
                ...
                <div class="col-md-6">
                  <select class="dropdown_buttons_1 dropdown-button" aria-label="Modelo" aria-describedby="basic-addon5"
      ...
      <div class="row g-0 bg-info fundo">
        <div class="col-md-12 d-flex align-items-center justify-content-center">
          <div class="carros">
            <div class="row g-0 bg-info fundo">
              <div class="col-md-6">
                <h2>X Carros na Pesquisa</h2>
              </div>
              <div class="col-md-6 d-flex align-items-center justify-content-end">
                <h3>Organizar por</h3>
                <select class="dropdown_buttons_2 dropdown-button" aria-label="Organizar-por"
                  aria-describedby="basic-addon1" onchange="resetSelection(this)">
                  <option value="" disabled selected hidden>Organizar Por</option>
                  <option value="Limpar">Limpar Seleção </option>
            ...
            <div class="row g-0 bg-info fundo">
              <div class="col-md-12 d-flex align-items-center justify-content-center">
                <div class="caixa_carros">
                  <div class="row d-flex align-items-center justify-content-center espacos">
                    <div class="col-md-2 d-flex align-items-center justify-content-center espacos">
                      <div class="card text-start">
                        <div class="card-body-maior">
                          ...
                          <div class="descricao_carro">
                            <h5> Titulo Carro </h5>
                            <p>
                              <i class="fas fa-tachometer-alt"></i> Ano
                            </p>
                            <p>
                              <i class="fas fa-tachometer-alt"></i> Kms
                            </p>
                            <p>
                              <i class="fas fa-tachometer-alt"></i> Combustivel
                            </p>
                            <p>
                              <i class="fas fa-tachometer-alt"></i> Kms
                            </p>
                            <div class="d-flex align-items-center justify-content-center">
                              <a href="" class="preco-maior d-flex align-items-center justify-content-center">Preço </a>
                            </div>
                          </div>
                        </div>
                      </div>
